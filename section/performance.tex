...
\begin{figure*}[h]
    \centering
    \subfigure[Throughput with different ratios.] {
        \includegraphics[scale=0.28]{contention/ratio_tput_bar.pdf}
        \label{fig:ratio_tput}
    }\hfill
    \subfigure[Delay in the \emph{ofo-queue} for different $Pkts_{ad}$.] {
        \includegraphics[scale=0.28]{contention/ratio_ofo_delay.pdf}
